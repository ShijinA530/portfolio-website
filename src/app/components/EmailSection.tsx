...
const EmailSection = () => {
  ...
  return (
    <section id='contact' className='grid md:grid-cols-2 my-12 py-24 gap-4 relative'>
      <div className='bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-primary-900 to-transparent rounded-full h-60 w-64 md:h-80 md:w-80 z-0 blur-lg absolute  -bottom-1/4 md:top-3/4 -left-2 transform -translate-x-1/2 -translate-1/2'></div>
      <div className='z-10'>
